...
int main(int argc, char const *argv[]) {
	...
	ofstream RMLog, RMStat, AvgTimes;
	RMLog.open("RM-Log.txt");		// opening the file in the append mode
	RMStat.open("RM-Stats.txt");	// opening the file in the append mode
	...
	AvgTimes << "RMS algorithm(Input according to 'inp-params.txt'): " << endl;
	for(int i=0; i<noOfProcesses; i++) {
